...
const routes: Routes = [
  ...
  {path: 'members', component: MembersPageComponent, canActivate: [OktaAuthGuard],
                    data: {onAuthRequired: sendToLoginPage}},
  // once the user is authenticated, it will be redirected to your app
...
@NgModule({
  ...
  providers: [
    ...
    // provide Token for HTTP interceptors, register AuthInterceptorService as an HTTP interceptor,
    // inform Angular that HTTP_INTERCEPTORS is a token for injection an array of values
